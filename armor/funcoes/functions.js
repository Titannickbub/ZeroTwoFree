...
const banner2 = cfonts.render(('Canal: youtube.com/titannickbub'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`ZERO TWO DARK`), {
font: 'chrome',             
align: 'center',           
...
authorname = 'ZERO TWO - CRIP 1.0'
packname = '-JR-'

const usedCommandRecently = new Set()

chyt = `553399865716@s.whatsapp.net`
